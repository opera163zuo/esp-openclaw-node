...
#define OPENCLAW_NODE_DEVICE_COMMAND_SCREEN_TEXT "device.screen.text"
#define OPENCLAW_NODE_DEVICE_COMMAND_SCREEN_FULLSCREEN_ENTER "device.screen.fullscreen.enter"
#define OPENCLAW_NODE_DEVICE_COMMAND_SCREEN_FULLSCREEN_TEXT "device.screen.fullscreen.text"
#define OPENCLAW_NODE_DEVICE_COMMAND_SCREEN_FULLSCREEN_CLEAR "device.screen.fullscreen.clear"
#define OPENCLAW_NODE_DEVICE_COMMAND_SCREEN_FULLSCREEN_EXIT "device.screen.fullscreen.exit"
