 ...
 *
 *         This used to live inside claw_core. It was lifted out into its own
 *         component because the device still needs path composition after the
 *         Agent and LLM stack were removed.
 */
typedef enum {
